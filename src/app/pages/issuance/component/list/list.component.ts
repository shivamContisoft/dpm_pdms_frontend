...
export class ListComponent {
  ...
  constructor(public appSettings: AppSettings, public dialog: MatDialog, public router: Router, public IssuanceService: IssuanceService,) {
    this.getIssuanceDetails();
  }

  getIssuanceDetails() {
    this.IssuanceService.getIssuanceDetails().subscribe(response => {

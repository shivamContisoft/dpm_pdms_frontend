...
export const verticalMenuItems = [ 
    ...
    new Menu (3, 'Upload', '/uploadpdf/list', null, 'library_books', null, false, 0), 
    new Menu (10, 'Upload', '/olduploadpdf/list', null, 'library_books', null, false, 0), 
    new Menu (4, 'Communication', '/communication/list', null, 'chat_bubble', null, false, 0), 
    new Menu (8, 'Issuance upload', '/issuance/list', null, 'chat_bubble', null, false, 0),
    new Menu (9, 'Health CheckUp upload', '/healthcheckup/list', null, 'chat_bubble', null, false, 0),
    new Menu (6, 'Delivery Report', '/report/delivery', null, 'delivery_dining', null, false, 0), 
    new Menu (7, 'Bounce Report', '/report/bounce', null, 'cancel', null, false, 0),
    // new Menu (5, 'Users', '/user/list', null, 'supervisor_account', null, false, 0), 
]

export const downloaderMenu = [ 
    new Menu (3, 'Download', '/uploadpdf/list', null, 'library_books', null, false, 0), 
    // new Menu (5, 'Users', '/user/list', null, 'supervisor_account', null, false, 0), 
]

export const uploaderMenu = [ 
    new Menu (1, 'Dashboard', '/dashboard', null, 'dashboard', null, false, 0),
    new Menu (3, 'Upload', '/uploadpdf/list', null, 'library_books', null, false, 0), 
    new Menu (10, 'Old Upload', '/olduploadpdf/list', null, 'library_books', null, false, 0), 
    new Menu (4, 'Communication', '/communication/list', null, 'chat_bubble', null, false, 0), 
    new Menu (8, 'Issuance upload', '/issuance/list', null, 'chat_bubble', null, false, 0),
    new Menu (9, 'Health CheckUp upload', '/healthcheckup/list', null, 'chat_bubble', null, false, 0),
    new Menu (6, 'Delivery Report', '/report/delivery', null, 'delivery_dining', null, false, 0), 
...
export const horizontalMenuItems = [ 
    new Menu (1, 'Dashboard', '/dashboard', null, 'dashboard', null, false, 0),
    new Menu (3, 'Upload PDF', '/uploadpdf/list', null, 'library_books', null, false, 0), 
    // new Menu (1, 'Dashboard', '/dashboard', null, 'dashboard', null, false, 0),
